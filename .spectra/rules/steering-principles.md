...
- Detailed documentation of `.spectra/` metadata directories (settings, automation)
...
- Light references to `.spectra/specs/` and `.spectra/steering/` are acceptable; avoid other `.spectra/` directories
