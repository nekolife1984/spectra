...
- Detailed documentation of `.spec/` metadata directories (settings, automation)
...
- Light references to `.spec/specs/` and `.spec/steering/` are acceptable; avoid other `.spec/` directories
