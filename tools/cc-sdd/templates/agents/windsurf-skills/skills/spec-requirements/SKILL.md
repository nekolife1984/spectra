...
1. **Load Context**:
   - Read `{{SPEC_DIR}}/specs/$1/spec.json` for language and metadata
   - Read `{{SPEC_DIR}}/specs/$1/brief.md` if it exists (discovery context: problem, approach, scope decisions, boundary candidates)
   - Read `{{SPEC_DIR}}/specs/$1/requirements.md` for project description
...
2. **Read Guidelines**:
   ...
   - Read `{{SPEC_DIR}}/settings/templates/specs/requirements.md` for document structure
...
5. **Finalize and Update Metadata**:
   - Write `{{SPEC_DIR}}/specs/$1/requirements.md` only after the requirements review gate passes
...
- **Scope Ambiguity Found During Requirements Review**: Stop execution, do not write a guessed `requirements.md`, and ask the user to clarify the missing or conflicting scope before re-running `$spec-requirements $1`

### Next Phase: Design Generation

**If Requirements Approved**:
- Review generated requirements at `{{SPEC_DIR}}/specs/$1/requirements.md`
