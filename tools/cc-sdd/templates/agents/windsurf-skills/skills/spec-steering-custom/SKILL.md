...
Otherwise:
- Check `{{SPEC_DIR}}/settings/templates/steering-custom/` for available templates
...
2. **Check if template exists**:
   - Load from `{{SPEC_DIR}}/settings/templates/steering-custom/{name}.md` if available
...
5. **Create file** in `{{SPEC_DIR}}/steering/{name}.md`

## Available Templates

Templates available in `{{SPEC_DIR}}/settings/templates/steering-custom/`:
...
## Created:
- {{SPEC_DIR}}/steering/api-standards.md
