...
# spec-validate-boundary — Boundary Validation
...
1. Verify `.spec/specs/$1/tasks.md` exists
2. If `$1` is empty, scan all features in `.spec/specs/`
...
```
/spec-validate-boundary photo-albums
/spec-validate-boundary                     # scan all features
/spec-validate-boundary photo-albums --fix  # auto-fix mode
```
