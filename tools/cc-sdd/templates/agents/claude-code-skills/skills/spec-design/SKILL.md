...
- `{{SPEC_DIR}}/specs/$1/spec.json`, `requirements.md`, `design.md` (if exists)
- `{{SPEC_DIR}}/specs/$1/research.md` (if exists, contains gap analysis from `$spec-validate-gap`)
...
- `{{SPEC_DIR}}/settings/templates/specs/design.md` for document structure
- Read `rules/design-principles.md` from this skill's directory for design principles
- `{{SPEC_DIR}}/settings/templates/specs/research.md` for discovery log structure
...
4. **Persist Findings to Research Log**:
   - Create or update `{{SPEC_DIR}}/specs/$1/research.md` using the shared template
...
1. **Load Design Template and Rules**:
   - Read `{{SPEC_DIR}}/settings/templates/specs/design.md` for structure
...
1. **Write Final Design and Research Log**:
   - Write `{{SPEC_DIR}}/specs/$1/design.md` only after the design review gate passes
...
1. **Status**: Confirm design document generated at `{{SPEC_DIR}}/specs/$1/design.md`
...
**Note**: The actual design document follows `{{SPEC_DIR}}/settings/templates/specs/design.md` structure.
...
- **User Message**: "No requirements.md found at `{{SPEC_DIR}}/specs/$1/requirements.md`"
- **Suggested Action**: "Run `$spec-requirements $1` to generate requirements first"

**Template Missing**:
- **User Message**: "Template file missing at `{{SPEC_DIR}}/settings/templates/specs/design.md`"
...
- **Suggested Action**: Clarify or fix `requirements.md`, then re-run `$spec-design $1`

### Next Phase: Task Generation

**If Design Approved**:
- Review generated design at `{{SPEC_DIR}}/specs/$1/design.md`
