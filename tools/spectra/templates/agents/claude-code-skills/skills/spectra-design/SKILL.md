...
- `{{SPECS_DIR}}/$1/spec.json`, `requirements.md`, `design.md` (if exists)
...
4. **Persist Findings to Research Log**:
   - Create or update `{{SPECS_DIR}}/$1/research.md` using the shared template
...
1. **Write Final Design and Research Log**:
   - Write `{{SPECS_DIR}}/$1/design.md` only after the design review gate passes
...
1. **Status**: Confirm design document generated at `{{SPECS_DIR}}/$1/design.md`
...
- **User Message**: "No requirements.md found at `{{SPECS_DIR}}/$1/requirements.md`"
...
**If Design Approved**:
- Review generated design at `{{SPECS_DIR}}/$1/design.md`
