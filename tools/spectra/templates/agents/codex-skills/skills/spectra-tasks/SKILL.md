...
- `{{SPECTRA_DIR}}/specs/$1/spec.json`, `requirements.md`, `design.md`
- `{{SPECTRA_DIR}}/specs/$1/tasks.md` (if exists, for merge mode)
...
**Write tasks.md**:
- Create/update `{{SPECTRA_DIR}}/specs/$1/tasks.md`
...
1. **Status**: Confirm tasks generated at `{{SPECTRA_DIR}}/specs/$1/tasks.md`
2. **Task Summary**: 
...
- **User Message**: "Missing requirements.md or design.md at `{{SPECTRA_DIR}}/specs/$1/`"
