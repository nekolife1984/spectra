...
# Usage:
#   # 全スキルを同期
#   bash tools/spectra/scripts/sync-skill.sh --all
#
#   # 特定のスキルのみ同期
#   bash tools/spectra/scripts/sync-skill.sh spectra-trace
#   bash tools/spectra/scripts/sync-skill.sh spectra-trace spectra-impact
#
#   # dry-run（何がコピーされるか確認）
#   bash tools/spectra/scripts/sync-skill.sh --dry-run spectra-trace
#
# 動作:
