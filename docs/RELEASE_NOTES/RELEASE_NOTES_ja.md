...
## 🛡️ Ver 3.0.1 (2026-04-11) - パス安全性の強化
...
## 🎉 Ver 3.0.0 (2026-04-10) - Skills Mode と自律実装
...
## 🔧 Ver 2.1.1 (2026-02-02) - バグ修正 & セキュリティ

### 修正
- OpenCodeエージェントのスラッシュコマンドでフルエージェントパスを使用するよう修正。

### セキュリティ
- vitestをv4に更新し、セキュリティ脆弱性を解決。
